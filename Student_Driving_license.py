...
pin = "568356"
print(type(pin))
address = "Kachi Talab Sadhanapuri"
print(type(address))
vehicle_type = "Four,Two Wheelers"
...
button1 = Button(root,text = "Show My Driving Lincence",command=myDrivingLicenceDetails)
